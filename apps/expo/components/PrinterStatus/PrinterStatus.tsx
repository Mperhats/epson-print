...
import { PrinterConstants, type PrinterStatusResponse } from 'react-native-esc-pos-printer';
...
export const PrinterStatus = memo(({ status }: PrinterStatusProps) => {
  ...
  const renderRow = (title: string, isGreenIndicator: boolean, isYellowIndicator?: boolean) => {
    return (
