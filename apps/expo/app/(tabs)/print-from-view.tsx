...
import { type DeviceInfo, Printer, PrinterConstants } from 'react-native-esc-pos-printer';

export default memo(function PrintFromViewScreen() {
  ...
  const print = async () => {
    if (!ref.current || !printerInstance) return;
      ...
      <View ref={ref} collapsable={false} style={styles.receiptContainer}>
        <View style={styles.row}>
          <Text style={styles.boldText}>
            Burger <Text style={[styles.normalText, styles.smallText]}>(without cheese)</Text>
          </Text>
          <Text>16 EUR</Text>
        </View>
        ...
        <View style={styles.row}>
          <Text style={styles.boldText}>
            Fries <Text style={[styles.normalText, styles.smallText]}>(medium)</Text>
          </Text>
          <Text>30 EUR</Text>
        </View>
        ...
        <View style={styles.row}>
          <Text style={styles.boldText}>
            Sous <Text style={[styles.normalText, styles.smallText]}>(sour)</Text>
          </Text>
          <Text>10 EUR</Text>
        </View>
